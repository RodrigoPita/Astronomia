...
while x != "Fim":
    ...
    print( "7 - Urano" )
    print( "8 - Netuno\n" )
    a = input("Digite o numero referente ao astro: ")
    print()
    print()
    if a == "0":
        print( "SOL" )
        ...
        print( "- Seu nucleo estah aproximadamente a ", Tsolnuc, "�C" )
        ...
        print( "- Sua temperatura estah em torno de ", Tven, "�C" )
        ...
        print( "- Seu nucleo eh composto de um envoltorio de ferro liquido em temperaturas acima de ", Tternuc, "�C" )
        ...
        print()
        b = input("Digite 'a' se quiser saber mais sobre a Lua, ou aperte 'enter' para continuar: ")
        if b == "a":
            print()
            print( "LUA" )
            print()
            ...
            print( "- Distancia de ", dluat, "km em relacao � Terra" )
        ...
        print()
        c = input("Digite 'a' se quiser saber mais sobre Ganimedes, ou aperte 'enter' para continuar: ")
        if c == "a":
            print()
            print( "GANIMEDES" )
            print()
        ...
        print()
        d = input("Digite 'a' se quiser saber mais sobre Tita, ou aperte 'enter' para continuar: ")
        if d == "a":
            print()
            print( "TITA" )
            print()
        ...
        print()
        e = input("Digite 'a' se quiser saber mais sobre esses satelites, ou aperte 'enter' para continuar: ")
        if e == "a":
            print()
            print( "MIRANDA" )
            print()
        ...
        print()
        f = input("Digite 'a' se quiser saber mais sobre Tritao, ou aperte 'enter' para continuar: ")
        if f == "a":
            print()
            print( "TRITAO" )
            print()
